...
namespace ODataCompositeKeys.Controllers
{
    ...
    */
    public class AuthorsController : ODataController
    {
        ...
        // GET: odata/Authors(5)/BookAuthors
        [EnableQuery]
        public IQueryable<BookAuthor> GetBookAuthors([FromODataUri] int key)
        {
            return db.Authors.Where(m => m.Id == key).SelectMany(m => m.BookAuthors);
        }
